...
namespace Yfsns\LaravelLocation\Models;
...
class Location extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = config('location.tables.locations', 'yfsns_locations');
    }
    ...
    {
        $postModel = config('location.post_model', \App\Modules\Post\Models\Post::class);
